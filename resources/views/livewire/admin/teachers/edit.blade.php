<div class="max-w-2xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-2xl font-semibold tracking-tight text-zinc-900">{{ __('Edit Teacher') }}</h2>
    </div>
    ...
    <div class="rounded-lg border border-zinc-200 bg-white shadow-sm p-6">
        <form wire:submit="save" class="space-y-4">
            ...
            <div class="flex gap-3 pt-2">
                ...
                <a href="{{ route('admin.teachers.index') }}" class="inline-flex items-center justify-center rounded-md text-sm font-medium border border-zinc-200 bg-white text-zinc-900 hover:bg-zinc-50 px-4 h-9 transition-colors">{{ __('Cancel') }}</a>
            </div>
        </form>
    </div>
</div>
